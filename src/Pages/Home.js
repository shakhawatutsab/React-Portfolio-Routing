                                ...
                                <li>
                                    <a href="#0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{ 
                                            fill:'rgba(0, 0, 0, 1)',transform:'ms-filter'
                    ...
                    <div className="column xl-12 grid-block grid-section-split">
                        ...
                        <div className="s-expertise__content-main grid-section-split__primary">
                            ...
                            <div className="grid-list-items list-items show-ctr">
                                ...
                                <div className="grid-list-items__item list-items__item">
                                    <div className="grid-list-items__title list-items__item-header">
                                        <h3 className="list-items__item-title">Research & Discovery</h3>
                                    </div>
                                    <div className="grid-list-items__text list-items__item-text">
                                        <p>
                                        Quibusdam quis autem voluptatibus earum vel ex error ea magni. Rerum quam quos. Aut asperiores 
                        ...
                        <div className="s-expertise__content-btn grid-section-split__bottom">
                            <a href="services.html" className="btn btn--stroke u-fullwidth">View All Services</a>
                        </div> {/* end s-about__content-btn */}
            ...
            <div className="row row-x-center text-center">
                <div className="column xl-8 lg-12">
                    ...
                    <div className="s-cta__content">
                        ...
                        <a href="contact.html" className="btn btn--primary">Let's Work Together</a>
                    </div>
                    ...
                    <div className="grid-full s-journal__content-main grid-list-items">
                        ...
                        <div className="grid-list-items__item blog-card">
                            <div className="blog-card__header">
                                ...
                                <h3 className="blog-card__title"><a href="https://www.dreamhost.com/r.cgi?287326">Need Web Hosting for Your Websites?</a></h3>
                            </div>
                        ...
                        <div className="grid-list-items__item blog-card">
                            <div className="blog-card__header">
                                ...
                                <h3 className="blog-card__title"><a href="single.html">5 Marketing Productivity Apps for Your Team</a></h3>
                            </div>
                            <div className="blog-card__text">
                                <p>
                                Rerum quam quos. Quibusdam quis autem voluptatibus earum vel ex error ea magni. Aut asperiores 
